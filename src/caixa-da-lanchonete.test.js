...
describe('CaixaDaLanchonete', () => {
    ...
    test.each([
        ['Item extra com item principal que não é equivalente', 'dinheiro', 'Item extra não pode ser pedido sem o principal', ['chantily,1', 'sanduiche,1']],
        ['Pedir mais de um item extra sem precisar pedir mais de um principal', 'dinheiro', 'R$ 5,70', ['chantily,2', 'cafe,1']],
        ['Combos não são considerados item principais', 'dinheiro', 'Item extra não pode ser pedido sem o principal', ['combo1,1', 'queijo,1']],
    ])('compra %p em %p deve resultar em %p', (_, formaDePagamento, resultadoEsperado, itens) =>
        validaTeste(formaDePagamento, resultadoEsperado, itens));
